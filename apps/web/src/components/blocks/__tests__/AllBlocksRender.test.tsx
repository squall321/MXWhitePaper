...
const BLOCKS: Record<string, Block> = {
  ...
  'flow-excalidraw': {
    ...
    id: ID(43),
    engine: 'excalidraw',
    // Minimal valid Excalidraw scene — single rectangle. exportToSvg
    // runs in a microtask so the initial server-rendered markup hits the
    // `rendering…` branch (deterministic, no random ids).
